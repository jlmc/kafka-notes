 ...
 * 1. reset the offset
 *
 * kafka-consumer-groups --bootstrap-server localhost:9092 --group App1 --reset-offsets --shift-by -2 --execute --topic FIRST_TOPIC
 * kafka-consumer-groups --bootstrap-server localhost:9092 --group App1 --describe
 *
 * 2. Rename the group.id
 *
 * ---
 *
 *  To list the consumers in the Kafka cluster, we can use the kafka-consumer-groups.sh shell script.
 ...
 *
 *  kafka-consumer-groups --describe --group App2 --members --bootstrap-server localhost:9092
 *
 */
public class ConsumerDemoAppOne {

    private static final Logger LOGGER = LoggerFactory.getLogger(ConsumerDemoAppOne.class);
